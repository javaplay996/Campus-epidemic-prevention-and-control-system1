    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="到校" prop="daoxiaoName">
                       <el-input v-model="ruleForm.daoxiaoName"
                                 placeholder="到校" clearable  :readonly="ro.daoxiaoName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="到校" prop="daoxiaoName">
                           <el-input v-model="ruleForm.daoxiaoName"
                                     placeholder="到校" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.daoxiaoFile" label="照片" prop="daoxiaoFile">
                        <file-upload
                                tip="点击上传照片"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.daoxiaoFile?$base.url+ruleForm.daoxiaoFile:''"
                                @change="daoxiaoFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.daoxiaoFile" label="照片" prop="daoxiaoFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.daoxiaoFile"  >照片下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="daoxiaoText">
                        <el-input type="textarea"  :readonly="ro.daoxiaoText" v-model="ruleForm.daoxiaoText" placeholder="备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.daoxiaoText" label="备注" prop="daoxiaoText">
                            <span v-html="ruleForm.daoxiaoText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.insertShijianTime"  class="input" label="到校时间" prop="insertShijianTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.insertShijianTime"
                                type="date"
                                placeholder="到校时间"
                                :disabled="ro.insertShijianTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.insertShijianTime" label="到校时间" prop="insertShijianTime">
                            <span v-html="ruleForm.insertShijianTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   daoxiaoName: [
                              { required: true, message: '到校不能为空', trigger: 'blur' },
                          ],
                   daoxiaoFile: [
                   ...
                   insertShijianTime: [
                              { required: true, message: '到校时间不能为空', trigger: 'blur' },
                          ],
                   daoxiaoDelete: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`daoxiao/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.daoxiaoCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            daoxiaoFileUploadChange(fileUrls){
                this.ruleForm.daoxiaoFile = fileUrls;
                this.addEditUploadStyleChange()
            },
