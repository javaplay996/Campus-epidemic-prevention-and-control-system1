    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="核酸打卡" prop="hesuanName">
                       <el-input v-model="ruleForm.hesuanName"
                                 placeholder="核酸打卡" clearable  :readonly="ro.hesuanName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="核酸打卡" prop="hesuanName">
                           <el-input v-model="ruleForm.hesuanName"
                                     placeholder="核酸打卡" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.hesuanFile" label="核酸照片" prop="hesuanFile">
                        <file-upload
                                tip="点击上传核酸照片"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.hesuanFile?$base.url+ruleForm.hesuanFile:''"
                                @change="hesuanFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.hesuanFile" label="核酸照片" prop="hesuanFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.hesuanFile"  >核酸照片下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="hesuanText">
                        <el-input type="textarea"  :readonly="ro.hesuanText" v-model="ruleForm.hesuanText" placeholder="备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.hesuanText" label="备注" prop="hesuanText">
                            <span v-html="ruleForm.hesuanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   hesuanName: [
                              { required: true, message: '核酸打卡不能为空', trigger: 'blur' },
                          ],
                   hesuanFile: [
                              { required: true, message: '核酸照片不能为空', trigger: 'blur' },
                          ],
                   hesuanText: [
        ...
        methods: {
            ...
            //图片
            hesuanFileUploadChange(fileUrls){
                this.ruleForm.hesuanFile = fileUrls;
                this.addEditUploadStyleChange()
            },
