        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '核酸打卡' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.hesuanName" placeholder="核酸打卡" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiaoyuanyiqingfangkongxitong/upload/hesuanMuBan.xls"
                        >批量导入核酸上报数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('hesuan','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   ...
                                   label="核酸打卡">
                        <template slot-scope="scope">
                            {{scope.row.hesuanName}}
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="hesuanFile"
                                     header-align="center"
                                     width="200"
                                     label="核酸照片">
                        <template slot-scope="scope">
                            <div v-if="scope.row.hesuanFile">
                                <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+scope.row.hesuanFile">下载</a>
                            </div>
                            <div v-else>无文件</div>
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      ...
                                      label="备注">
                        <template slot-scope="scope">
                            <span v-if="scope.row.hesuanText != null &&scope.row.hesuanText.length>10">
                                {{scope.row.hesuanText.slice(0,10)}}...
                            </span>
                            <span v-else>
                                {{scope.row.hesuanText}}
                            </span>
                        </template>
                    </el-table-column>
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'hesuan',//当前表表名,
                        sumColum : 'hesuan_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'hesuan_name',//分组字符串字段
                        // types : 'hesuan_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
            ...
            getDataList() {
                ...
                if (this.searchForm.hesuanName!= '' && this.searchForm.hesuanName!= undefined) {
                    params['hesuanName'] = '%' + this.searchForm.hesuanName + '%'
                }
