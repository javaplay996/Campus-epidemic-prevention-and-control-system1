    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="药品地点" prop="yaopinAddress">
                       <el-input v-model="ruleForm.yaopinAddress"
                                 placeholder="药品地点" clearable  :readonly="ro.yaopinAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="药品地点" prop="yaopinAddress">
                           <el-input v-model="ruleForm.yaopinAddress"
                                     placeholder="药品地点" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yaopinAddress: [
                              { required: true, message: '药品地点不能为空', trigger: 'blur' },
                          ],
                   yaopinTypes: [
