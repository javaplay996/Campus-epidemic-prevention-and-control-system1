...
var centerMenu = [
    ...
    ,{
        name: '到校确认',
        url: '../daoxiao/list.html'
    }
    ,{
        name: '核酸上报',
        url: '../hesuan/list.html'
    }
    ,{
        name: '确诊上报',
        url: '../quezhen/list.html'
    }
    ,{
        name: '药品订单',
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/xiaoyuanyiqingfangkongxitong/admin/dist/index.html#/login";
