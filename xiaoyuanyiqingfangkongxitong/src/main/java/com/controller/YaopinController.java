    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(yaopin !=null){
            ...
            //级联表 用户
            //级联表
            YonghuEntity yonghu = yonghuService.selectById(yaopin.getYonghuId());
            if(yonghu != null){
    ...
    */
    ...
    public R save(@RequestBody YaopinEntity yaopin, HttpServletRequest request){
        ...
        if(false)
            ...
            yaopin.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<YaopinEntity> queryWrapper = new EntityWrapper<YaopinEntity>()
            .eq("yonghu_id", yaopin.getYonghuId())
            .eq("yaopin_name", yaopin.getYaopinName())
            .eq("yaopin_address", yaopin.getYaopinAddress())
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            YaopinEntity yaopinEntity = new YaopinEntity();
//                            yaopinEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
...
//                            yaopinEntity.setYaopinAddress(data.get(0));                    //药品地点 要改的
