...
public class NewsEntity<T> implements Serializable {
     ...
     * 疫情知识名称
     */
    @ColumnInfo(comment="疫情知识名称",type="varchar(200)")
     ...
     * 疫情知识图片
     */
    @ColumnInfo(comment="疫情知识图片",type="varchar(200)")
     ...
     * 疫情知识类型
     */
    @ColumnInfo(comment="疫情知识类型",type="int(11)")
     ...
     * 疫情知识详情
     */
    @ColumnInfo(comment="疫情知识详情",type="longtext")
